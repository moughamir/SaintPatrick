...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=2b5e4eae035c9fc045aa)
 * Config saved to config.json and https://gist.github.com/2b5e4eae035c9fc045aa
 */
...
function JeuController($scope, $timeout) {
...
JeuController.$inject = ["$scope", "$timeout"];
...
app.controller("JeuController", JeuController)
